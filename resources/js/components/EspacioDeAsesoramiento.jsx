        ...
        <main>
            ...
            (<ContenedorTab>
              ...
              <div className="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a className="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Documentacion</a>
              </div>
            </nav>
